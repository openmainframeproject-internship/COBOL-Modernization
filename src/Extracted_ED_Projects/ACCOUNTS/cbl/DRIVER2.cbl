...
005100       15  OUT03O-BAL6N REDEFINES OUT03O-BAL6 PIC -(7).99.        cbankd03
...
006300                                                                  cbankd03
       ...
       000-START-PROCESSING.
           ...
           SET ADDRESS OF CUST-ID
              TO ADDRESS OF DFHCOMMAREA
           
           CALL 'GETBAL' USING DFHEIBLK
                                DFHCOMMAREA
                                CUST-ID
                                BALANCE-OUT2 

           SET ADDRESS OF BALANCE-OUT
              TO ADDRESS OF DFHCOMMAREA

           MOVE BALANCE-OUT2 TO BALANCE-OUT                            
